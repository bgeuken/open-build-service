...
class ProjectTest < ActiveSupport::TestCase
  ...
  def test_flags_to_axml
    # check precondition
    assert_equal 2, @project.flags.flags_of_type('build').size
    assert_equal 2, @project.flags.flags_of_type('publish').size
  ...
  def test_add_new_flags_from_xml
    ...
    # check results
    assert_equal 1, @project.flags.flags_of_type('build').size
    assert_equal 'disable', @project.flags.flags_of_type('build')[0].status
    assert_equal '10.2', @project.flags.flags_of_type('build')[0].repo
    assert_equal 'i586', @project.flags.flags_of_type('build')[0].architecture.name
    assert_equal 1, @project.flags.flags_of_type('build')[0].position
    assert_nil @project.flags.flags_of_type('build')[0].package
    assert_equal 'home:Iggy', @project.flags.flags_of_type('build')[0].project.name

    assert_equal 1, @project.flags.flags_of_type('publish').size
    assert_equal 'enable', @project.flags.flags_of_type('publish')[0].status
    assert_equal '10.2', @project.flags.flags_of_type('publish')[0].repo
    assert_equal 'x86_64', @project.flags.flags_of_type('publish')[0].architecture.name
    assert_equal 2, @project.flags.flags_of_type('publish')[0].position
    assert_nil @project.flags.flags_of_type('publish')[0].package
    assert_equal 'home:Iggy', @project.flags.flags_of_type('publish')[0].project.name

    assert_equal 1, @project.flags.flags_of_type('debuginfo').size
    assert_equal 'disable', @project.flags.flags_of_type('debuginfo')[0].status
    assert_equal '10.0', @project.flags.flags_of_type('debuginfo')[0].repo
    assert_equal 'i586', @project.flags.flags_of_type('debuginfo')[0].architecture.name
    assert_equal 3, @project.flags.flags_of_type('debuginfo')[0].position
    assert_nil @project.flags.flags_of_type('debuginfo')[0].package
    assert_equal 'home:Iggy', @project.flags.flags_of_type('debuginfo')[0].project.name
  end
  ...
  def test_delete_flags_through_xml
    ...
    assert_equal 0, @project.flags.flags_of_type('build').size
    assert_equal 0, @project.flags.flags_of_type('publish').size
  end
