...
class DebuginfoFlagTest < ActiveSupport::TestCase
  ...
  def test_add_debug_flag_to_project
    ...
    assert_equal 2, @project.flags.flags_of_type('debuginfo').size
    ...
    # check the result
    assert_equal 4, @project.flags.flags_of_type('debuginfo').size

    f = @project.flags.flags_of_type('debuginfo')[2]
    ...
    f = @project.flags.flags_of_type('debuginfo')[3]
    assert_kind_of Flag, f
  ...
  def test_add_debug_flag_to_package
    ...
    # check the result
    assert_equal 3, @package.flags.flags_of_type('debuginfo').size

    f = @package.flags.flags_of_type('debuginfo')[1]
    assert_kind_of Flag, f
    ...
    f = @package.flags.flags_of_type('debuginfo')[2]
    assert_kind_of Flag, f
  ...
  def test_delete_debuginfo_flags_from_project
    ...
    # destroy flags
    @project.flags.flags_of_type('debuginfo')[1].destroy
    # reload required!
    @project.reload
    assert_equal 1, @project.flags.flags_of_type('debuginfo').size
    assert_equal 1, count - Flag.all.size

    @project.flags.flags_of_type('debuginfo')[0].destroy
    # reload required
    @project.reload
    assert_equal 0, @project.flags.flags_of_type('debuginfo').size
  ...
  def test_delete_debuginfo_flags_from_package
    ...
    # destroy flags
    @package.flags.flags_of_type('debuginfo')[0].destroy
    # reload required!
    @package.reload
    assert_equal 0, @package.flags.flags_of_type('debuginfo').size
    assert_equal 1, count - Flag.all.size
  end
  ...
  def test_position
    ...
    @project.reload
    assert_equal 3, @project.flags.flags_of_type('debuginfo').size
